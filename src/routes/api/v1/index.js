...
const AnswerCommentController = new (require('../../../controllers/AnswerCommentController'))();
...
// ANSWER COMMENTS
router.all('/answers/:answer_id/answer_comments*', auth, findItem('Answer', 'answer_id'))
router.get('/answers/:answer_id/answer_comments', AnswerCommentController.index)
router.post('/answers/:answer_id/answer_comments', AnswerCommentController.create)
router.all('/answers/:answer_id/answer_comments/:id', findItem('AnswerComment'))
router.get('/answers/:answer_id/answer_comments/:id', AnswerCommentController.show)
router.delete('/answers/:answer_id/answer_comments/:id', AnswerCommentController.destroy)
